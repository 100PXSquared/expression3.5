...
function PANEL:Init()
	...
	self.btnValidate:SetColor(Color(200, 200, 255))
...
function PANEL:DoValidate(Goto, Code, Native)
	...
	if not Code or Code == "" then
		self:OnValidateError(false, {msg = "No code submited, interpreter exited.", line = 0, char = 0});
		return false
	end
...
function PANEL:OnValidateError(Goto, Thrown)
	...
	self.btnValidate:SetColor(Color(255, 100, 100))
