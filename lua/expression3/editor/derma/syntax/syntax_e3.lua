...
---------------------------------------------------------------------------]]
local colors = {
	["comment"] = Color(87, 166, 74),
	["function"] = Color(220, 220, 170),
	["library"] = Color(200, 200, 200),
	["constant"] = Color(255, 0, 0), -- NOT IMPLEMENTED
	["keyword"] = Color(216, 160, 213),
	["notfound"] = Color(220, 220, 220),
	["number"] = Color(181, 206, 168),
	["operator"] = Color(180, 180, 180),
	["string"] = Color(214, 157, 133),
	["datatype"] = Color(86, 156, 214),
	["class"] = Color(78, 201, 176),
	["userfunction"] = Color(220, 220, 170),
	["variable"] = Color(200, 200, 200),
	["directive"] = Color(155, 155, 155),
	["attribute"] = Color(154, 154, 154),
}
...
setmetatable(colors, {
	__index = function(tbl, index) return Color(220) end
})
					...
					if not inline then
						...
						if self:NextPattern("^[a-zA-Z][a-zA-Z0-9_]*") then
							if self.tClasses[self.sBuffer] then
								if self.datatypes[self.sBuffer] then
									self:AddToken("datatype")
								else
									self:AddToken("class")
								end
							else
