...
extension:RegisterFunction("system", "getEntity", "", "e", 1, function(context) return tokens[context].entity end);
extension:RegisterFunction("system", "getOwner", "", "p", 1, function(context) return tokens[context].player end);
...
extension:RegisterFunction("system", "quotaMax", "", "n", 1, function(context) return tokens[context]:softTimeLimit(); end);
extension:RegisterFunction("system", "netQuotaMax", "", "n", 1, function(context) return tokens[context]:GetNetQuota(); end);

extension:RegisterFunction("system", "quota", "", "n", 1, function(context) return tokens[context].net_total or 0; end);
extension:RegisterFunction("system", "netQuota", "", "n", 1, function(context) return tokens[context].cpu_total or 0; end);

extension:RegisterFunction("system", "quotaUsage", "", "n", 1, function(context) return tokens[context].cpu_softusage or 0; end);
extension:RegisterFunction("system", "quotaAverage", "", "n", 1, function(context) return tokens[context].cpu_average or 0; end);
extension:RegisterFunction("system", "movingQuotaAverage", "", "n", 1, function(context) return tokens[context]:movingCPUAverage(); end);
...
extension:RegisterFunction("system", "printTable", "t", "", 0, function(context, t)
	...
	tokens[context].entity:SendToOwner(EXPR_PRINT_GOLEM, s);
end);
